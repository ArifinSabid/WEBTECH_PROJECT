...
body{
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
		...
		<li class="nav-item">
          <a class="nav-link" href="#" onclick="loadDoc1()">Contact us</a>
        </li>
  ...
  <p style="float: left;">
		...
		<legend align="center"><h1  > Welcome to <?php echo $_SESSION["Name"]?> the Customer of our Hotel <h1/></legend>
			<span>  </span>
		</fieldset>
    ...
    <marquee behavior="scroll" direction="left" scrollamount="12"><h4>Welcome to Hotel Radisson Blu</h4></marquee>
...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="500">
      <img src="../uploads/1234.jpg" class="d-block w-100" alt="..." height="700px" >
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
    <div class="carousel-item" data-bs-interval="2000">
      <img src="../uploads/88.jpg" class="d-block w-100" alt="..." height="700px" >
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
    <div class="carousel-item">
      <img src="../uploads/55.jpg" class="d-block w-100" alt="..." height="700px">
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
  </div>
...
<script>
function mOver(obj) {
  obj.innerHTML = "Welcome to our hotel page"
}
