...
<div class="container">
  <h1>Contact Us</h1>
  <!--yourgmailname converted to your email address-->
  <form target="_blank" action="https://formsubmit.co/yourgmailname@gmail.com" method="POST">
    ...
    <button type="submit" class="btn btn-lg btn-dark btn-block">Submit Form</button> <br>
  </form>
</div>
