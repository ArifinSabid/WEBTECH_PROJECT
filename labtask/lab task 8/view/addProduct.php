...
<nav class="navbar navbar-expand-lg navbar-white bg-white static-top">
  <div class="container">
    <a class="navbar-brand" href="../view/Dashboad.php">
      <img src="../uploads/3.png" alt="..." height="50">
    </a>
      ...
      <table align="center" width="1000">
        <tr>
          ...
          <form action="../controller/createProduct.php" method="POST" enctype="multipart/form-data">
           <body><tr>
            <table align="center" border ="5" width ="500" height= "500">

            
            <td colspan="38" align="center"><h1>Create Product</h1></td>
            <tr></tr>
           
           <td colspan="5" align="center"><label for="name">Room No</label>
            <input type="text" id="name" name="name"></td>
            <td colspan="5" align="center"><label for="buying">Room Category</label>
            <input type="text" id="buying" name="buying"></td>
            <td colspan="2" align="center"><label for="selling">Services</label>
            <input type="text" id="selling" name="selling"></td>
            <td colspan="5" align="center"><label for="quantity">Product Price</label>
            <input type="text" id="quantity" name="quantity"></td>
            <td colspan="5" align="center"><label for="quantity">Image</label>
            <input type="file" name="image"></td><tr></tr>
            <tr>
            <td colspan="100" align="right"> <input type="submit" name = "createProduct" value="create">
            <input type="reset"> </td><
            </tr>
            </body>
</form> 
