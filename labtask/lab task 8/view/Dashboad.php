  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto">
		...
		<legend align="center"><h1  > Welcome to <?php echo $_SESSION["Name"]?> Welcome to Hotel Radisson Blu admin  page </h1></legend>
			<span> <p> </p> </span>
		</fieldset>
...
<div>
		...
		<div class="pp1">
        <img src="../uploads/6.jpg" alt="#" width="100%">
		<div id="demo">
<p>Ground floor swimming pool</p>
<button type="button" onclick="loadDoc()">See more</button>
    ...
    <div class="pp1">
        <img src="../uploads/7.jpg" alt="#" width="100%">
		<div id="demo1">
<p>Roof top swimming pool</p>
